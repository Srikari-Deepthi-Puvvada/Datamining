...
OBJECTIVE:
The main aim is to build a Naive Bayes classifier to to find whether an essay is written by human or by an LLM. To design this I am going to use the data-set from LLM - Detect AI Generated Text competition in Kaggle. The data set consists of set of human written essays and LLM generated essay.
